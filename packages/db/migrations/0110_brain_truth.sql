...
-- extract-product@1.2.0 builds on 1.1.0 (0109's before/after and minors image review).
update model_routes set prompt_version = 'extract-product@1.2.0' where task = 'extract.product_facts' and prompt_version in ('extract-product@1.0.0', 'extract-product@1.1.0');
